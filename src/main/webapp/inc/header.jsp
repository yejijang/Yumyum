...
<header class="main-header">
	<section>
		...
		<nav>
			<ul>
				<li class="mainbtn" onclick="location.href='/yumyum/category_delivery.do';"
					title="delivery" id="/yumyum/category_delivery.do">배달</li>
				<li class="mainbtn" onclick="location.href='/yumyum/category_pickup.do';"
					title="pickup" id="/yumyum/category_pickup.do">포장</li>
				<li class="mainbtn" onclick="location.href='/yumyum/noticelist.do';"
			...
			<!-- 점주
			<ul>
				<li class="mainbtn" onclick="location.href='/yumyum/owner/shop/shop_add.do';"
					title="shopedit" id="/yumyum/owner/shop/shop_add.do">가게관리</li>
				<li class="mainbtn" onclick="location.href='/yumyum/owner/menu/menulist.do';"
					title="menulist" id="/yumyum/owner/menu/menulist.do">메뉴관리</li>
				<li class="mainbtn" onclick="location.href='/yumyum/order/own_orderlist.do';"
					title="orderlist" id="/yumyum/owner/order/own_orderlist.do">주문관리</li>	
				<li class="mainbtn" onclick="location.href='/yumyum/owner/review/reviewevent.do';"
			...
			<!-- 관리자
			<ul>
				<li class="mainbtn" onclick="location.href='/yumyum/admin/shop/shopenroll.do';"
					title="shopenroll.do" id="/yumyum/admin/shop/shopenroll.do">가게관리</li>
				<li class="mainbtn" onclick="location.href='/yumyum/admin/member/customerlist.do';"
					title="customerlist" id="/yumyum/admin/member/customerlist.do">회원관리</li>
				<li class="mainbtn" onclick="location.href='/yumyum/admin/event/eventlist.do';"
					title="eventlist" id="/yumyum/admin/event/eventlist.do">이벤트관리</li>	
				<li class="mainbtn" onclick="location.href='/yumyum/admin/question/questionlist.do';"
					title="questionlist" id="/yumyum/admin/question/questionlist.do">자주묻는질문관리</li>
				<li class="mainbtn" onclick="location.href='/yumyum/admin/notice/noticelist.do';"
		...
		<div class="auth">
			...
			<div class="btn-auth" onclick="location.href='/yumyum/auth/auth_select.do';" title="회원가입">회원가입</div>
			<i class="glyphicon glyphicon-shopping-cart" onclick="location.href='/yumyum/cart.do';"></i>
			<i class="glyphicon glyphicon-user" onclick="location.href='/yumyum/customer/mypage/mypage.do';"></i>
		</div>
	</section>
</header>